...
class RHD_Calendario// implements RHD_Calendario
{
	...
	public function assets() {
		...
		wp_enqueue_style( 'fullcalendar', plugins_url( 'dist/js/vendor/fullcalendar/dist/fullcalendar.css', __FILE__ ) );
		wp_enqueue_style( 'vex', plugins_url( 'dist/js/vendor/vex-js/dist/css/vex.css', __FILE__ ) );
		wp_enqueue_style( 'vex-theme', plugins_url( 'dist/js/vendor/vex-js/dist/css/vex-theme-flat-attack.css', __FILE__ ) );
		// wp_enqueue_style( 'fullcalendar', plugins_url( 'css/fullcalendar/fullcalendar.css', __FILE__ ) );
		wp_enqueue_style( 'calendario', plugins_url( 'dist/css/main.css', __FILE__ ) );

		// JS
		//wp_register_script( 'jquery-rhd', plugins_url( 'node_modules/jquery/dist/jquery.min.js', __FILE__ ), array(), '3.3.1', true );
		wp_register_script( 'moment', plugins_url( 'dist/js/vendor/moment/moment.js', __FILE__ ), array(), '2.19.3', true );
		wp_register_script( 'fullcalendar', plugins_url( 'dist/js/vendor/fullcalendar/dist/fullcalendar.js', __FILE__ ), array( 'jquery', 'moment' ), '3.7.0', true );
		wp_register_script( 'vex', plugins_url( 'dist/js/vendor/vex-js/dist/js/vex.combined.min.js', __FILE__ ), array(), '4.0.1', true );

		wp_enqueue_script( 'calendario', plugins_url( 'dist/js/calendario.js', __FILE__ ), array( 'jquery', 'jquery-ui-draggable', 'moment', 'fullcalendar', 'vex' ), RHD_CALENDARIO_VERSION, true );
		wp_enqueue_script( 'calendario-modals', plugins_url( 'dist/js/calendario-modals.js', __FILE__ ), array( 'jquery', 'jquery-ui-draggable', 'moment', 'fullcalendar', 'calendario' ), null, true );
		wp_enqueue_script( 'calendario-view', plugins_url( 'dist/js/calendario-view.js', __FILE__ ), array( 'jquery', 'jquery-ui-draggable', 'moment', 'fullcalendar', 'calendario', 'calendario-modals' ), null, true );
