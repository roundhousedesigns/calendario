...
function scrollToDate(date, animateTime) {
	 ...
	 * Fixes:
	 * 
	 * instead of a date range, see if it's too crazy to get the whole calendar? or to load a big empty calendar and load events on the fly as you scroll in? This will probably be in calendario-views.js
	 */
	if (!animateTime) {
		animateTime = 0;
	}
	...
	// console.log(".fc-day-top[data-date='" + startOfMonth + "']");
	let elPosition =
